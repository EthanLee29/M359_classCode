...
public class QuizDriver
{
    public static void main(String[] args)
    {
        ...
        int popQuizTotalPts = popQuiz.calcTotal(1);
        ...
        //          Total Points:   #
        popQuiz.printInfo();
        System.out.println("\t\tTotal Points:\t" + popQuizTotalPts);
        ...
        // Store in an appropriate variable
        int u2QuizPts = unit2Quiz.calcTotal(3);

        // *** WRITE CODE HERE ***
        // Part L
        // Calculate unit2Quiz extra credit
        // Store in an appropriate variable
        int u2QuizEC = unit2Quiz.calcExtraCredit();
        ...
        unit2Quiz.printInfo();
        System.out.println("\t\tExtra Credit:\t" + u2QuizEC);
        System.out.println("\t\tTotal Points:\t" + (u2QuizEC + u2QuizPts));
